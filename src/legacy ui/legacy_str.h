...
namespace xor_strs
{
    ...
    // Anti-aim string definitions in legacy_str.h
    ...
    extern std::string aa_pitch_switch;
    extern std::string aa_pitch_3way;
    extern std::string aa_pitch_flick;
    extern std::string aa_pitch_dynamic;

    extern std::string aa_yaw_back;
    extern std::string aa_yaw_spin;

    // Defensive yaw modes
    extern std::string def_yaw_disabled;
    extern std::string def_yaw_back;
    extern std::string def_yaw_spin;
    extern std::string def_yaw_random;
    extern std::string def_yaw_lby_breaker;
    extern std::string def_yaw_sideways_switch;
    extern std::string def_yaw_at_targets;
    extern std::string def_yaw_freestanding;
    extern std::string def_yaw_fake_angle;
    extern std::string def_yaw_spin_slow;
    extern std::string def_yaw_jitter_defensive;
    extern std::string def_yaw_180_flick;
    extern std::string def_yaw_edge;
    extern std::string def_yaw_cross;
    // Defensive exploit modes
    extern std::string def_mode_disabled;
    extern std::string def_mode_on_peek;
    extern std::string def_mode_always_air;
    extern std::string def_mode_always_on;
    ...
    extern std::string flick_pitch;
    extern std::string dynamic_pitch;
    ...
    extern std::string netypiski8;
    extern std::string netypiski9;

    extern std::string defensive_flick;

    extern std::string pitch_flick_fast;
    extern std::string pitch_flick_medium;
    extern std::string pitch_flick_slow;
    extern std::string pitch_flick_random;
    extern std::string pitch_dynamic_smooth;
    extern std::string pitch_dynamic_step;
    extern std::string pitch_dynamic_jitter;

    extern std::string step_jitter;
    extern std::string jitter45;
    extern std::string jitter;
    extern std::string sideways;
    ...
    extern std::string vanilla_nekopara;
    extern std::string putin;
    extern std::string coconut;
    extern std::string lara_croft;
    extern std::string poison;
    extern std::string jill;
    extern std::string gasaiyono;
    extern std::string miku_goth;
    extern std::string green_anime;
    extern std::string tiara;
    extern std::string end_chan;
    extern std::string yoru;
    extern std::string ballas;
    extern std::string addidas_girl;
    extern std::string maid;
    extern std::string gs_tate;
    extern std::string hatsune_miku;
    extern std::string gabe_newell;
    extern std::string boykisser;
    extern std::string dog_girl;
    extern std::string hatsune_miku;
    extern std::string gs_tate;
    ...
    extern std::string glove_skin_buckshot;
    extern std::string glove_skin_fade;
    extern std::string glove_skin_mogul;

    // Peek pitch modes
    extern std::string peek_pitch_up;
    extern std::string peek_pitch_down;
    extern std::string peek_pitch_zero;
    extern std::string peek_pitch_custom;
    extern std::string peek_pitch_meowmode;

    // Peek pitch phases
    extern std::string peek_phase_peek;
    extern std::string peek_phase_return;
    extern std::string peek_phase_both;

    // Peek jitter modes
    extern std::string peek_jitter_off;
    extern std::string peek_jitter_binary;
    extern std::string peek_jitter_progressive;
    extern std::string peek_jitter_random;
    extern std::string peek_jitter_stepped;
