...
namespace xor_strs
{
	...
	// Defensive yaw modes
	std::string def_yaw_disabled;
	std::string def_yaw_back;
	std::string def_yaw_spin;
	std::string def_yaw_random;
	std::string def_yaw_lby_breaker;
	std::string def_yaw_sideways_switch;
	std::string def_yaw_at_targets;
	std::string def_yaw_freestanding;
	std::string def_yaw_fake_angle;
	std::string def_yaw_spin_slow;
	std::string def_yaw_jitter_defensive;
	std::string def_yaw_180_flick;
	std::string def_yaw_edge;
	std::string def_yaw_cross;

	// Defensive exploit modes
	std::string def_mode_disabled;
	std::string def_mode_on_peek;
	std::string def_mode_always_air;
	std::string def_mode_always_on;
	...
	std::string netypiski8;
	std::string netypiski9;

	std::string static_pitch;
	std::string random_pitch;
	std::string switch_pitch;
	std::string way_pitch;
	std::string flick_pitch;
	std::string dynamic_pitch;
	std::string def_dynamic;
	std::string def_dynamic_type;
	std::string pitch_flick_fast;
	std::string pitch_flick_medium;
	std::string pitch_flick_slow;
	std::string pitch_flick_random;
	std::string pitch_dynamic_smooth;
	std::string pitch_dynamic_step;
	std::string pitch_dynamic_jitter;
	std::string aa_pitch_custom;
	std::string aa_pitch_random;
	std::string aa_pitch_switch;
	std::string aa_pitch_3way;
	std::string aa_pitch_flick;
	std::string aa_pitch_dynamic;
	std::string flick;
	// jitter helper strings
	std::string step_jitter;
	std::string jitter45;
	std::string jitter;
	std::string sideways;
	std::string random;
	std::string adaptive;
	std::string defensive_flick;
	...
	// Custom player model labels
	std::string vanilla_nekopara;
	std::string putin;
	std::string coconut;
	std::string lara_croft;
	std::string poison;
	std::string jill;
	std::string gasaiyono;
	std::string miku_goth;
	std::string green_anime;
	std::string tiara;
	std::string end_chan;
	std::string yoru;
	std::string ballas;
	std::string addidas_girl;
	std::string maid;
	std::string gs_tate;
	std::string hatsune_miku;
	std::string gabe_newell;
	std::string boykisser;
	std::string dog_girl;
	...
	std::string glove_skin_buckshot;
	std::string glove_skin_fade;
	std::string glove_skin_mogul;

	// Peek pitch modes
	std::string peek_pitch_up;
	std::string peek_pitch_down;
	std::string peek_pitch_zero;
	std::string peek_pitch_custom;
	std::string peek_pitch_meowmode;

	// Peek pitch phases
	std::string peek_phase_peek;
	std::string peek_phase_return;
	std::string peek_phase_both;

	// Peek jitter modes
	std::string peek_jitter_off;
	std::string peek_jitter_binary;
	std::string peek_jitter_progressive;
	std::string peek_jitter_random;
	std::string peek_jitter_stepped;
	...
	void init()
	{
		...
		weapon_default = XOR("Default");
		weapon_auto = XOR("Auto");
		weapon_heavy_pistols = XOR("Heavy Pistols");
		weapon_pistols = XOR("Pistols");
		weapon_ssg08 = XOR("SSG08");
		weapon_awp = XOR("AWP");
		weapon_negev = XOR("Negev");
		weapon_m249 = XOR("M249");
		weapon_ak47 = XOR("AK47");
		weapon_aug = XOR("AUG");
		weapon_duals = XOR("Duals");
		weapon_p250 = XOR("P250");
		weapon_cz = XOR("CZ");

		// Chams initialization
		vis_chams_textured = XOR("Textured");
		vis_chams_metallic = XOR("Metallic");
		vis_chams_flat = XOR("Flat");
		vis_chams_glass = XOR("Glass");
		vis_chams_glow = XOR("Glow");
		vis_chams_bubble = XOR("Bubble");
		vis_chams_money = XOR("Money");
		vis_chams_fadeup = XOR("Fadeup");
		...
		cfg_misc = XOR("Misc");
		cfg_custom1 = XOR("Custom 1");
		cfg_custom2 = XOR("Custom 2");
		...
		target_damage = XOR("Damage");
		target_distance = XOR("Distance");
		...
		aa_yaw_back = XOR("Back");
		aa_yaw_spin = XOR("Spin");

		// Defensive yaw modes
		def_yaw_disabled = XOR("Disabled");
		def_yaw_back = XOR("Back");
		def_yaw_spin = XOR("Spin");
		def_yaw_random = XOR("Random");
		def_yaw_lby_breaker = XOR("LBY Breaker");
		def_yaw_sideways_switch = XOR("Sideways Switch");
		def_yaw_at_targets = XOR("At Targets");
		def_yaw_freestanding = XOR("Freestanding");
		def_yaw_fake_angle = XOR("Fake Angle");
		def_yaw_spin_slow = XOR("Spin Slow");
		def_yaw_jitter_defensive = XOR("Jitter Defensive");
		def_yaw_180_flick = XOR("180° Flick");
		def_yaw_edge = XOR("Edge Yaw");
		def_yaw_cross = XOR("Cross");
		// Defensive exploit modes
		def_mode_disabled = XOR("Disabled");
		def_mode_on_peek = XOR("On Peek");
		def_mode_always_air = XOR("Always in Air");
		def_mode_always_on = XOR("Always On");
		...
		way_pitch = XOR("3-way");
		flick_pitch = XOR("Flick");
		dynamic_pitch = XOR("Dynamic");
		def_dynamic = XOR("Dynamic");
		def_dynamic_type = XOR("Type");
		pitch_flick_fast = XOR("Fast");
		pitch_flick_medium = XOR("Medium");
		pitch_flick_slow = XOR("Slow");
		pitch_flick_random = XOR("Random");
		pitch_dynamic_smooth = XOR("Smooth");
		pitch_dynamic_step = XOR("Step");
		pitch_dynamic_jitter = XOR("Jitter");
		aa_pitch_custom = XOR("Custom");
		aa_pitch_random = XOR("Random");
		aa_pitch_switch = XOR("Switch");
		aa_pitch_3way = XOR("3-way");
		aa_pitch_flick = XOR("Flick");
		aa_pitch_dynamic = XOR("Dynamic");
		flick = XOR("Flick");
		step_jitter = XOR("Step");
		jitter45 = XOR("45");
		jitter = XOR("Jitter");
		sideways = XOR("Sideways");
		random = XOR("Random");
		adaptive = XOR("Adaptive");
		defensive_flick = XOR("Flick");
		...
		weapon_cfg_usps = XOR("USPS");
		weapon_cfg_cz75 = XOR("CZ75");
		...
		agent_danger_a = XOR("Danger A");
		agent_danger_b = XOR("Danger B");
		agent_danger_c = XOR("Danger C");
		agent_cmdr_davida = XOR("Commander D'Avida");
		agent_cmdr_frank = XOR("Commander Frank");
		agent_cmdr_lieutenant = XOR("Commander Lieutenant");
		agent_cmdr_michael = XOR("Commander Michael");
		agent_cmdr_operator = XOR("Commander Operator");
		agent_cmdr_spec_agent_ava = XOR("Commander Special Agent Ava");
		agent_cmdr_markus = XOR("Commander Markus");
		agent_cmdr_sous = XOR("Commander Sous Chef");
		agent_cmdr_chem_haz = XOR("Commander Chem Haz");
		agent_cmdr_chef_d = XOR("Commander Chef D");
		agent_cmdr_aspirant = XOR("Commander Aspirant");
		agent_cmdr_officer = XOR("Commander Officer");
		agent_cmdr_d_sq = XOR("Commander D Sq");
		agent_cmdr_b_sq = XOR("Commander B Sq");
		agent_cmdr_seal_team6 = XOR("Commander SEAL Team 6");
		agent_cmdr_bunkshot = XOR("Commander Bunkshot");
		agent_cmdr_lt_commander = XOR("Commander Lt Commander");
		agent_cmdr_bunkshot2 = XOR("Commander Bunkshot 2");
		agent_cmdr_3rd_commando = XOR("Commander 3rd Commando");
		agent_cmdr_two_times_ = XOR("Commander Two Times");
		agent_cmdr_two_times_2 = XOR("Commander Two Times 2");
		agent_cmdr_premeiro = XOR("Commander Premeiro");
		agent_cmdr_cmdr = XOR("Commander Cmdr");
		agent_cmdr_1st_le = XOR("Commander 1st LE");
		agent_cmdr_john_van = XOR("Commander John Van");
		agent_cmdr_bio_haz = XOR("Commander Bio Haz");
		agent_cmdr_sergeant = XOR("Commander Sergeant");
		agent_cmdr_chem_haz__ = XOR("Commander Chem Haz 2");
		agent_cmdr_farwlo = XOR("Commander Farwlo");
		agent_cmdr_getaway_sally = XOR("Commander Getaway Sally");
		agent_cmdr_getaway_number_k = XOR("Commander Getaway Number K");
		agent_cmdr_getaway_little_kev = XOR("Commander Getaway Little Kev");
		agent_cmdr_safecracker = XOR("Commander Safecracker");
		agent_cmdr_bloody_darryl = XOR("Commander Bloody Darryl");
		agent_cmdr_bloody_loud = XOR("Commander Bloody Loud");
		agent_cmdr_bloody_royale = XOR("Commander Bloody Royale");
		agent_cmdr_bloody_skullhead = XOR("Commander Bloody Skullhead");
		agent_cmdr_bloody_silent = XOR("Commander Bloody Silent");
		agent_cmdr_bloody_miami = XOR("Commander Bloody Miami");
		...
		agent_prof_shahmat = XOR("Professor Shahmat");
		agent_prof_osiris = XOR("Professor Osiris");
		agent_prof_ground_rebek = XOR("Professor Ground Rebek");
		agent_prof_elite_muhlik = XOR("Professor Elite Muhlik");
		agent_prof_trapper = XOR("Professor Trapper");
		agent_prof_trapper_aggressor = XOR("Professor Trapper Aggressor");
		agent_prof_vypa_sista = XOR("Professor Vypa Sista");
		agent_prof_col_magnos = XOR("Professor Col Magnos");
		agent_prof_crasswater = XOR("Professor Crasswater");
		agent_prof_crasswater_forgotten = XOR("Professor Crasswater Forgotten");
		agent_prof_solman = XOR("Professor Solman");
		agent_prof_romanov = XOR("Professor Romanov");
		agent_prof_blackwolf = XOR("Professor Blackwolf");
		agent_prof_maximus = XOR("Professor Maximus");
		agent_prof_dragomir = XOR("Professor Dragomir");
		agent_prof_dragomir2 = XOR("Professor Dragomir 2");
		agent_prof_rezan = XOR("Professor Rezan");
		agent_prof_rezan_red = XOR("Professor Rezan Red");

		vanilla_nekopara = XOR("Vanilla (Nekopara)");
		putin = XOR("Putin");
		coconut = XOR("Coconut");
		lara_croft = XOR("Lara Croft");
		poison = XOR("Poison");
		jill = XOR("Jill");
		gasaiyono = XOR("Gasaiyono");
		miku_goth = XOR("Miku Goth");
		green_anime = XOR("Green Anime");
		tiara = XOR("Tiara");
		end_chan = XOR("End chan");
		yoru = XOR("Yoru");
		ballas = XOR("Ballas");
		addidas_girl = XOR("Addidas Girl");
		maid = XOR("Maid");
		gs_tate = XOR("GS Tate");
		hatsune_miku = XOR("Hatsune Miku");
		gabe_newell = XOR("Gabe newell");
		boykisser = XOR("Boy Kisser");
		dog_girl = XOR("Dog girl");
		...
		glove_skin_buckshot = XOR("Buckshot");
		glove_skin_fade = XOR("Fade");
		glove_skin_mogul = XOR("Mogul");

		// Peek pitch modes
		peek_pitch_up = XOR("Up");
		peek_pitch_down = XOR("Down");
		peek_pitch_zero = XOR("Zero");
		peek_pitch_custom = XOR("Custom");
		peek_pitch_meowmode = XOR("Meowmode");

		// Peek pitch phases
		peek_phase_peek = XOR("On peek");
		peek_phase_return = XOR("On return");
		peek_phase_both = XOR("Both");

		// Peek jitter modes
		peek_jitter_off = XOR("Off");
		peek_jitter_binary = XOR("Binary");
		peek_jitter_progressive = XOR("Progressive");
		peek_jitter_random = XOR("Random");
		peek_jitter_stepped = XOR("Stepped");
	}
}
