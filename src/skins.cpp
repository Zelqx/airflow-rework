...
namespace skin_changer
{
	...
	{
		XOR("models\\player\\custom_player\\legacy\\tm_jumpsuit_varianta.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jumpsuit_variantb.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jumpsuit_variantc.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_diver_varianta.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_diver_variantb.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_diver_variantc.mdl"),
		...
		XOR("models\\player\\custom_player\\legacy\\ctm_gendarmerie_varianta.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gendarmerie_variantb.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gendarmerie_variantc.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gendarmerie_variantd.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gendarmerie_variante.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_sas_variantg.mdl"),
		...
		XOR("models\\player\\custom_player\\legacy\\ctm_st6_variantn.mdl"),
		...
		XOR("models\\player\\custom_player\\legacy\\ctm_swat_variantk.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varj.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_vari.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varh.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varg.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varf5.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varf4.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varf3.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varf2.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varf1.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_professional_varf.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_phoenix_varianti.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_phoenix_varianth.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_phoenix_variantg.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_phoenix_variantf.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_leet_variantj.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_leet_varianti.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_leet_varianth.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_leet_variantg.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_leet_variantf.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jungle_raider_variantf2.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jungle_raider_variantf.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jungle_raider_variante.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jungle_raider_variantd.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jungle_raider_variantb2.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jungle_raider_variantb.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_jungle_raider_varianta.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_balkan_varianth.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_balkan_variantj.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_balkan_varianti.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_balkan_variantf.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_balkan_variantg.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_balkan_variantk.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_balkan_variantl.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gign.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gign_variantA.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gign_variantB.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gign_variantC.mdl"),
		XOR("models\\player\\custom_player\\legacy\\ctm_gign_variantD.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_pirate.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_pirate_variantA.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_pirate_variantB.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_pirate_variantC.mdl"),
		XOR("models\\player\\custom_player\\legacy\\tm_pirate_variantD.mdl"),
		// Custom player models
		XOR("models\\player\\custom_player\\neru\\pneumaf2.mdl"),
		XOR("models\\player\\custom_player\\toppiofficial\\nekopara\\vanilla_f1.mdl"),
		XOR("models\\player\\custom_player\\night_fighter\\putin\\putin.mdl"),
		XOR("models\\player\\custom_player\\bbs_93x_net_2016\\coconut\\update_2016_12_30\\coconut.mdl"),
		XOR("models\\player\\custom_player\\voikanaa\\tru\\lara.mdl"),
		XOR("models\\player\\custom_player\\voikanaa\\streetfighter\\poison.mdl"),
		XOR("models\\player\\custom_player\\voikanaa\\rehd\\jill.mdl"),
		XOR("models\\player\\custom_player\\voikanaa\\mirainikki\\gasaiyono.mdl"),
		XOR("models\\player\\custom_player\\uuz\\gothic_miku\\gothic_miku.mdl"),
		XOR("models\\player\\custom_player\\maoling\\fairyfancyf\\tiara\\tiara.mdl"),
		XOR("models\\player\\custom_player\\2019x\\dogirl\\a0.mdl"),
		XOR("models\\player\\custom_player\\end\\hsqp\\hsqp.mdl"),
		XOR("models\\player\\custom_player\\kolka\\adidas_girl\\adidas_girl_v2.mdl"),
		XOR("models\\player\\custom_player\\kolka\\yoru_csgo\\yoru_csgo.mdl"),
		XOR("models\\player\\custom_player\\frnchise9812\\ballas2.mdl"),
		XOR("models\\player\\custom_player\\toppiofficial\\kancolle\\hibiki_maid.mdl"),
		XOR("models\\player\\custom_player\\frnchise9812\\gamesensee.mdl"),
		XOR("models\\player\\custom_player\\toppiofficial\\vocaloid\\yyb\\miku_10th_v2.mdl"),
		XOR("models\\player\\custom_player\\nf\\gabe_newell.mdl"),
		XOR("models\\player\\custom_player\\likeaworm\\boykisser.mdl"),
	};

	__forceinline const char* get_model_name(int team)
	{
		int menu_index = team == 2 ? g_cfg.skins.model_t : g_cfg.skins.model_ct;

		// Index 0 = Default
		if (menu_index == 0)
			return "";

		// Calculate custom index dynamically
		int custom_index = player_models.size() + 1; // +1 for "Default"

		// Custom model
		if (menu_index == custom_index)
			return team == 2 ? g_cfg.skins.custom_model_t : g_cfg.skins.custom_model_ct;

		// Array index = menu_index - 1
		int array_index = menu_index - 1;

		if (array_index >= 0 && array_index < (int)player_models.size())
			return player_models[array_index].c_str();

		return "";
	}

	__forceinline std::string get_model_name_str(int team)
	{
		int menu_index = team == 2 ? g_cfg.skins.model_t : g_cfg.skins.model_ct;
		...
		int custom_index = player_models.size() + 1;

		// Custom model
		if (menu_index == custom_index)
		{
			const char* custom = team == 2 ? g_cfg.skins.custom_model_t : g_cfg.skins.custom_model_ct;
			return custom[0] ? std::string(custom) : std::string();
		}
		...
		if (array_index >= 0 && array_index < (int)player_models.size())
			return player_models[array_index];

		return std::string();
	}
	static std::array<std::string, 20> custom_model_names = {
		XOR("Green Anime"),
		XOR("Vanilla (Nekopara)"),
		XOR("Putin"),
		XOR("Coconut"),
		XOR("Lara Croft"),
		XOR("Poison"),
	...
	__forceinline const char* get_custom_model_name(int index)
	{
		if (index >= 0 && index < (int)custom_model_names.size())
			return custom_model_names[index].c_str();
		return "";
	};
	...
	__forceinline void agent_changer(int stage)
	{
		...
		// Dynamic calculation: player_models.size() + 1 (for "Default")
		int custom_index = player_models.size() + 1;
		bool use_custom_models = team == 2 && g_cfg.skins.model_t == custom_index || team == 3 && g_cfg.skins.model_ct == custom_index;
		...
		auto model = get_model_name_str(HACKS->local->team());
		...
		// If file doesn't exist, revert to original
		...
		if (idx == 0)
		{
			// Model doesn't exist - revert to original
			if (original_model != 0)
				HACKS->local->set_model_index(original_model);
			else
				call_force_update = true;
	...
	__forceinline void on_game_events(c_game_event* event)
	{
		...
		if (!std::strcmp(event->get_name(), CXOR("round_start")))
		{
			...
			auto model_t = get_model_name_str(2);
			auto model_ct = get_model_name_str(3);

			if (!model_t.empty() && !should_precache(model_t.c_str()))
				g_cfg.skins.model_t = 0; // Reset to default if missing

			if (!model_ct.empty() && !should_precache(model_ct.c_str()))
				g_cfg.skins.model_ct = 0;
	...
	std::vector<std::string> get_player_model_labels()
	{
		std::vector<std::string> labels;
		labels.reserve(player_models.size());

		for (size_t i = 0; i < player_models.size(); ++i)
		{
			// Check if this is a custom model (last 20 entries)
			if (i >= player_models.size() - custom_model_names.size())
			{
				auto custom_idx = i - (player_models.size() - custom_model_names.size());
				labels.push_back(custom_model_names[custom_idx]);
			}
			else
			{
				// Extract better names for standard models
				auto path = player_models[i];

				// Find last two directory separators for better context
				auto last_sep = path.find_last_of('\\');
				auto second_last_sep = path.find_last_of('\\', last_sep - 1);

				std::string name;
				if (second_last_sep != std::string::npos && last_sep != std::string::npos)
				{
					// Get parent_folder/filename
					name = path.substr(second_last_sep + 1);
				}
				else
				{
					name = last_sep != std::string::npos ? path.substr(last_sep + 1) : path;
				}
				...
				// Replace backslashes with forward slashes for readability
