...
public:
	...
	{
		// OLD CODE (kept for revert) had the arguments reversed, so it copied
		// the entity's poses INTO the array and never restored the entity.
		math::memcpy_sse(pose_parameter(), poses, sizeof(float) * 24);
	}
